...
//根据商铺获取食品分类列表
export const reqFoodListByRestaurantId=(restaurantId)=>ajax.get(`/shopping/v2/menu?restaurant_id=${restaurantId}`)
//根据食品分类列表获取食品列表
export const reqFoodsByCategoryId=(categoryId)=>ajax.get(`/shopping/v2/menu/${categoryId}`)
//获取评价分类
